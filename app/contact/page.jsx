...
const page = () => {
  return (
    <section
    class="flex items-center bg-gradient-to-r from-gray-50 to-blue-50 xl:h-screen font-poppins dark:from-gray-900 dark:to-gray-900 ">
        <div class="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto lg:py-10 md:px-7 dark:bg-gray-800">
